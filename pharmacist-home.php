...
<div class="topnav" id="myTopnav">
	<a id="active" href="pharmacist-home.php">Home</a>
...
<form class="form-content" action="php/data-pharmacist-update.php" method="POST" enctype="multipart/form-data" autocomplete="on">
	...
	<fieldset>
		...
		<textarea name="pharmacy_address" id="pharmacy_address" rows="6" title="This field cannot be changed." disabled>
'.$_SESSION['pharmacy_street'].'
